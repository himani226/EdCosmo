...
// Add context class to each selector in the CSS (instead 'body')
if (!function_exists('trx_addons_css_add_context')) {
	function trx_addons_css_add_context($css, $context) {
		$css = trim( $context . ' '
						. trx_addons_str_replace_once(
							array(
								// Leave unchanged
								'-body{',
								'_body{',
		...
		$css = str_replace(
						array(
							'",' . $context,
							$context . ' }',
							$context . ' @-webkit-keyframes',
							$context . ' @-ms-keyframes',
							$context . ' @keyframes',
							$context . ' 25%',
							$context . ' 50%',
							$context . ' 100%',
