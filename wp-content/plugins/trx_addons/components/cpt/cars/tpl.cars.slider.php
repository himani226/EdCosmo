	...
	?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_cars sc_cars_<?php 
		...
		?><div class="sc_cars_content sc_item_content"><?php
			...
			trx_addons_show_layout(trx_addons_get_slider_layout(array(
				...
				'slides_space' => (int)$args['slides_space'] > 0 ? $args['slides_space'] : 0,
				'slides_centered' => (int)$args['slides_centered'] > 0 ? 'yes' : 'no',
				'slides_overflow' => (int)$args['slides_overflow'] > 0 ? 'yes' : 'no',
				'mouse_wheel' => (int)$args['slider_mouse_wheel'] > 0 ? 'yes' : 'no',
				'autoplay' => (int)$args['slider_autoplay'] > 0 ? 'yes' : 'no',
