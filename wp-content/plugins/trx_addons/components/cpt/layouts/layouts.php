...
if ( trx_addons_exists_sop() && trx_addons_components_is_allowed('api', 'siteorigin-panels')
...
if ( trx_addons_exists_gutenberg() && trx_addons_components_is_allowed('api', 'gutenberg')
		&& ($fdir = trx_addons_get_file_dir(TRX_ADDONS_PLUGIN_CPT . "layouts/layouts_gutenberg.php")) != '') {
	include_once $fdir;
}
