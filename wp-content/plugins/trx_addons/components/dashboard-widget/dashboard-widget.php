...
if ( !function_exists( 'trx_addons_dashboard_widget_display' ) ) {
	function trx_addons_dashboard_widget_display() {
		// Get theme info & feed
		$theme_info = apply_filters('trx_addons_filters_get_theme_feed', trx_addons_get_theme_info());
...
if ( !function_exists( 'trx_addons_get_theme_feed' ) ) {
	add_filter( 'trx_addons_filters_get_theme_feed', 'trx_addons_get_theme_feed' );
