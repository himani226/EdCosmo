				...
				<div class="comment-content post-content" itemprop="text">
					...
					<div class="comment-meta post-meta" role="complementary">
						<div class="comment-author">
							...
							<span class="comment-author-says"><?php esc_attr_e( 'says:', 'thype' ) ?></span>
							<?php comment_reply_link(array_merge( $args, array('reply_text' => '<span>'.esc_html__('Reply', 'thype' ).'</span>', 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
							<?php edit_comment_link( esc_html__('Edit this comment','thype' ),'',''); ?>
						</div>
