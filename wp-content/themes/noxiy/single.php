...
if (is_array($noxiy_meta) && array_key_exists('site_layout', $noxiy_meta) && $noxiy_meta['layout_enable'] != 'no') {
	...
	$site_layout = noxiy_option('single_layout', 'right-sidebar');
}
...
if (is_array($noxiy_meta) && array_key_exists('breadcrumb_enable', $noxiy_meta)) {
	$enable_banner = $noxiy_meta['breadcrumb_enable'];
} else {
	$enable_banner = 'yes';
}

if (is_array($noxiy_meta) && array_key_exists('section_padding', $noxiy_meta)) {
...
<main id="primary" class="site-main">
	...
	?>
	<div class="blog__details <?php echo esc_attr($section_padding);?>">
		<div class="container">
			<div class="row">
				<?php
