  ...
  function ot_type_import( $args = array() ) {
	...
	if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'false'){ 
      ...
      ?>
		...
		<!--<p><input type="radio" name="import_content" value="options" >Layouts (will also import latest shop layout)</p><br> -->
		...
		<p><input type="radio" name="import_demo" value="shop" >Shop-> <a target = "_blank" href="http://amory.premiumcoding.com/shop-demo">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="shop-sidebar" >Shop with sidebar-> <a target = "_blank" href="http://amory.premiumcoding.com/shop-demo-sidebar">Check demo</a></p>
		<?php } else { ?>
		<p><span style="color:#E74C3C">Note: </span>If you wish to import Shop Demo content you will need to install WooCommerce first!</p>
		<?php } ?>
