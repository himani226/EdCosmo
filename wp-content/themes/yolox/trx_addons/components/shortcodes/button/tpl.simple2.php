	...
	if (!empty($args['image']) || !empty($args['icon'])) {
		?><span class="sc_button_icon"><?php
			if (!empty($args['image'])) {
				...
				?><img class="sc_icon_as_image" src="<?php echo esc_url($args['image']); ?>" alt="<?php esc_attr_e('Icon', 'yolox'); ?>"<?php echo (!empty($attr[3]) ? ' '.trim($attr[3]) : ''); ?>><?php
				...
				if (strpos($args['icon'], '.svg') !== false) {
					...
					?><img class="sc_icon_as_image" src="<?php echo esc_url($args['icon']); ?>" alt="<?php esc_attr_e('Icon', 'yolox'); ?>"<?php echo (!empty($attr[3]) ? ' '.trim($attr[3]) : ''); ?>><?php
				}
