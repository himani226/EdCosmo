...
if ( ! function_exists( 'yolox_customizer_get_css' ) ) {

	function yolox_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = yolox_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'yolox_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = yolox_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'yolox_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( yolox_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = yolox_get_scheme_colors( $s );
					}
...
dt, b, em, mark, ins {	/* not 'i', because it used as icons container */
	color: {$colors['text']};
}
s, strike, del {	
...
.scheme-dark table th, .scheme-dark table th + th,
 .scheme-sdark table td + th  {
	border-color: {$colors['alter_bd_color']};
}
.scheme-self table td, table th + td, 
.scheme-self table td + td {
	color: {$colors['text']};
	border-color: {$colors['alter_bd_color']};
}
table th {
...
.sc_button_simple2:not(.sc_button_bg_image):before,
...
.sc_button_simple2:not(.sc_button_bg_image):hover, 
...
.scheme_dark.btn-fullwidth .sc_button_simple2:not(.sc_button_bg_image):hover, 
.scheme_dark.btn-fullwidth .sc_button_simple:not(.sc_button_bg_image):hover {
...
.sc_button_bordered:not(.sc_button_bg_image) {
	color:{$colors['text_dark']};
	-webkit-box-shadow: 0px 0px 50px -16px {$colors['text_link2']};
	    -ms-box-shadow: 0px 0px 50px -16px {$colors['text_link2']};
			box-shadow: 0px 0px 50px -16px {$colors['text_link2']};	
	background-color: {$colors['input_bg_color']} !important;				
}
.sc_button_bordered:not(.sc_button_bg_image):hover {
	color:{$colors['text_link2']} !important;
	-webkit-box-shadow: 0px 2px 20px 0px {$colors['text_link_05']};
	    -ms-box-shadow: 0px 2px 20px 0px {$colors['text_link_05']};
			box-shadow: 0px 2px 20px 0px {$colors['text_link_05']};	
}
...
.mc4wp-form input[type="submit"]{
    ...
    -webkit-box-shadow: 0px 0px 31px -7px {$colors['text_link_03']};
	    -ms-box-shadow: 0px 0px 31px -7px {$colors['text_link_03']};
			box-shadow: 0px 0px 31px -7px {$colors['text_link_03']};	
}
...
.sc_button.color_style_link2:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):not(.sc_button_simple2) {
	background-color: {$colors['text_link2']};
}
.sc_button_default.color_style_link3,
.sc_button.color_style_link3:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):not(.sc_button_simple2) {
	background-color: {$colors['text_link3']};
}
.sc_button_default.color_style_dark,
.sc_button.color_style_dark:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):not(.sc_button_simple2) {
...
input[type="submit"].color_style_link3 {
    color: {$colors['inverse_hover']};
	background-color: {$colors['text_link']};
	-webkit-box-shadow: 0px 0px 19px -7px {$colors['text_link']};
	    -ms-box-shadow: 0px 0px 19px -7px {$colors['text_link']};
			box-shadow: 0px 0px 19px -7px {$colors['text_link']};	
}
...
.scheme_self.sidebar .sc_button_bordered:not(.sc_button_bg_image):hover {
	color:{$colors['text_link2']} !important;
	-webkit-box-shadow: 0px 0px 50px -10px {$colors['text_link2']};
	    -ms-box-shadow: 0px 0px 50px -10px {$colors['text_link2']};
			box-shadow: 0px 0px 50px -10px {$colors['text_link2']};	
}
...
.footer_wrap .scheme_self .elementor-text-editor a{
    color: {$colors['text']};
}
.footer_wrap .scheme_self .elementor-text-editor a:hover{
    color: {$colors['text_link']};
}
...
.yolox_tabs .yolox_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.yolox_tabs .yolox_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .yolox_tabs .yolox_tabs_titles li.ui-state-active a {
...
body .post_item_single .post_meta_item.post_counters_views:hover,
.slider_container .slide_info.slide_info_large .post_counters_comments,
.single-post .post_meta .post_meta_item:hover{
	color: {$colors['text_light']};
}
.post_date a:hover,
...
.post_info_counters .post_counters_item:hover,
 .slider_container .slide_info.slide_info_large .post_counters_comments:hover{
	color: {$colors['text_link']};
}
...
.slider_container .slide_info.slide_info_large .post_counters_views:before,
.post_meta .post_meta_item.trx_addons_icon-eye:before{
    color: {$colors['text_link3']};
}
...
.post_format_audio .post_title a{
    color: {$colors['inverse_text']};
}
.related_wrap .post_format_audio .post_title a:hover,
.post_format_audio .post_title a:hover{
    color: {$colors['text_link']};
}
.related_wrap .post_format_audio .post_title a{
    color: {$colors['text_dark']};
}
...
.sc_recent_news_style_announce2 .sc_item_button,
...
body .posts_container .more-link:hover,
.more-link:hover{
    color: {$colors['text_link2']} !important;
...
.footer_wrap .scheme_default ul li a{
    color: {$colors['text']};
}

.wp-widget-nav_menu ul li > a:hover,
.footer_wrap .scheme_default ul li a:hover{
    color: {$colors['text_link']};
}
...
.recent_news_item_content .post_categories > a:hover,
.sc_blogger_item_content .post_meta .post_categories > a:hover,
.post_header_single .post_categories a:hover{
    color: {$colors['inverse_text']} !important;
     background-color: {$colors['extra_hover3']};
}

.meta_author_atts .post_meta .author_name a{
    color: {$colors['text_dark']};
}
.meta_author_atts .post_meta .author_name a:hover{
    color: {$colors['text_link']};
}
...
body .posts_container .post_item, body .posts_container .related_item{
    background-color: {$colors['alter_bg_color']};
}
...
.socials_share.socials_type_drop .social_item .social_icon:hover{
     color: {$colors['text_link']} !important;
}
...
.slider_container.slider_multi .post_meta span, 
.slider_container .slide_info:not(.slide_info_large) .post_meta span,
.slider_container.slider_multi .post_meta a, 
.slider_container .slide_info:not(.slide_info_large) .post_meta a{
    color: {$colors['inverse_link']};
}
...
.slider_container.slider_multi .post_meta span:hover, 
.slider_container .slide_info:not(.slide_info_large) .post_meta .post_meta_item:hover,
.slider_container.slider_multi .post_meta a:hover, 
.slider_container .slide_info:not(.slide_info_large) .post_meta a:hover{
    color: {$colors['text_link']} 
}
...
CSS;
					...
					$rez            = apply_filters(
						'yolox_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'yolox_filter_prepare_css', $css_str, $remove_spaces );
	}
}
