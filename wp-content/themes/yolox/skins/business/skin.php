<?php
/**
 * Skins support: Main skin file for the skin 'Business'
 *
...
if ( ! function_exists( 'yolox_skin_importer_set_options' ) ) {
    ...
    function yolox_skin_importer_set_options($options = array()) {
        if (is_array($options)) {
            // Business News demo
            $options['demo_type'] = 'business';
            $options['files']['business'] = $options['files']['default'];
            $options['files']['business']['title'] = esc_html__('Agency News Demo', 'yolox');
            $options['files']['business']['domain_dev']  = esc_url( yolox_get_protocol() . '://business.yolox.ancorathemes.com/' );
            $options['files']['business']['domain_demo'] = esc_url( yolox_get_protocol() . '://business.yolox.ancorathemes.com/' );   // Demo-site domain
