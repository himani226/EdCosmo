...
if ( ! function_exists( 'yolox_trx_addons_add_theme_vars' ) ) {
	add_filter( 'yolox_filter_add_theme_vars', 'yolox_trx_addons_add_theme_vars', 10, 2 );
	function yolox_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'yolox_trx_addons_get_css' ) ) {
	add_filter( 'yolox_filter_get_css', 'yolox_trx_addons_get_css', 10, 2 );
	function yolox_trx_addons_get_css( $css, $args ) {
...
.trx_addons_tabs .trx_addons_tabs_titles li a,
.trx_addons_dropcap,
...
.blogger_header_wrap .sc_blogger_filters .sc_blogger_filters_titles li a,
...
.sc_matches_item_pair .sc_matches_item_player .post_featured > img {
	-webkit-border-radius: {$vars['rad360']};
	    -ms-border-radius: {$vars['rad360']};
			border-radius: {$vars['rad360']};
}
...
.trx_addons_tabs .trx_addons_tabs_titles .trx_addons_tabs_title{
...
.single_share .socials_share.socials_type_drop .social_item:hover{
    background-color: {$colors['text_hover2']} !important;
}

.single_share .socials_share.socials_type_drop .social_item > .social_icon > span,
.single_share .socials_share.socials_type_drop .social_item > .social_icon > i {
	color: {$colors['inverse_link']};
}
...
.single_share .socials_share.socials_type_drop .social_item:hover > .social_icon > span,
.single_share .socials_share.socials_type_drop .social_item:hover > .social_icon > i {
	color: {$colors['inverse_link']};
}
...
.sc_promo_text.trx_addons_blockquote_style_1,
...
.elementor-widget-trx_sc_icons .sc_icons .sc_icons_item_description a[href^="tel:"]{
    color: {$colors['alter_text']};
}
.elementor-widget-trx_sc_icons .sc_icons .sc_icons_item_description a[href^="tel:"]:hover{
    color: {$colors['text_hover']};
}
